...
```{r}
baseline_r %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall))
svdd_r  %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
oneclass_r %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
smote_50_r %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
smote_60_r %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
smote_65_r %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
weights_r  %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
lr_r %>% group_by(file, Corrected) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
svdd_cr %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
oneclass_cr %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
smote_50_cr %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
smote_60_cr %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
smote_65_cr %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
weights_cr  %>% group_by(file) %>% mutate(media = mean(recall), varianza = sd(recall)) %>% select(file,media, varianza)
```
...
### F1
#### Estadísticos
Cálcularemos la media y la varianza de F1.
```{r}
baseline_r %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file, media, varianza)
svdd_r  %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
oneclass_r %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
smote_50_r %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
smote_60_r %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
smote_65_r %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
weights_r  %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
lr_r %>% group_by(file, Corrected) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
svdd_cr %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
oneclass_cr %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
smote_50_cr %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
smote_60_cr %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
smote_65_cr %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
weights_cr  %>% group_by(file) %>% mutate(media = mean(F1), varianza = sd(F1)) %>% select(file,media, varianza)
```


### Boxplots
A continuación dibujaremos gráficas de cajas para la métrica F1.
```{r}
